...
export default function NewEvidencePage() {
  ...
  // Estados para a vítima (sem dependência de API)
  ...
  // Validação do formulário (sem dependência de seleção de vítima)
  const isFormValid =
    casoReferencia &&
    categoria &&
    coletadoPorNome &&
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError("Erro simulado ao enviar os dados.");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="w-full max-w-3xl">
          ...
          >
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              {/* Seção de Dados da Vítima (sem <select>) */}
              ...
              {submitted && evidenceId && (
                <div className="space-y-4">
                  <p className="text-green-600 text-sm">Evidência cadastrada com sucesso (simulado)!</p>
                  <button
